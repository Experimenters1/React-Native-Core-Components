...
const styles = StyleSheet.create({
  container: {
     ...
     flexDirection: 'column-reverse', // Các thành phần con sẽ nằm ngang
    ...
    marginVertical: 60 // Thêm khoảng cách dọc giữa các items
  },
  ...
  item: {
    ...
    // marginVertical: 10 // Thêm khoảng cách dọc giữa các items
